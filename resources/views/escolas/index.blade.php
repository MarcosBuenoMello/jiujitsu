	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				<a href="{{ route('escolas.create') }}" class="btn btn-success ml-1 mb-3">
					<i class="la la-plus"></i> Cadastrar escola
				</a>

				<a href="{{ route('escolas.listAlunos') }}" class="btn btn-info ml-1 mb-3">
					<i class="la la-list"></i> Ver todos os alunos
				</a>
				<h1 class="h3 mb-2 text-gray-800">Escolas</h1>
							...
							<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
								...
								<div class="dropdown no-arrow">
									...
									<div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"aria-labelledby="dropdownMenuLink">
										...
										<a class="dropdown-item text-warning" href="{{ route('escolas.edit', $item->id) }}"><i class="la la-edit mr-2"></i>Editar</a>

										<form action="{{ route('escolas.destroy', $item->id) }}" method="post"
											id="form-{{$item->id}}">
											@csrf
											@method('delete')
								...
								<div class="row no-gutters align-items-center">
									<div class="col mr-2">
										...
										<div class="h6 mb-0 font-weight-bold text-gray-800">
											Total de alunos: 
											<strong>{{sizeof($item->alunos)}}</strong>
										</div>
